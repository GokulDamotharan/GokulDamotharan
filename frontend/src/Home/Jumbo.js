...
import { Calendar, Shield, Activity, Zap, Heart, TrendingUp, ChevronRight } from "lucide-react";
        ...
        <div className="col-lg-6">
          ...
          >
            ...
            <motion.div
              ...
              style={{ padding: '8px 20px', borderRadius: 'var(--radius-full)', fontSize: '0.875rem' }}
            >
              <Zap size={16} />
            ...
            {/* Main Heading */}
            <h1 className="display-4 font-weight-bold mb-4" style={{ lineHeight: '1.2' }}>
              <span className="text-gradient">Next-Gen</span> Healthcare
              <br />
              <span style={{ color: 'var(--color-text-primary)' }}>Appointment System</span>
            </h1>

            {/* Description */}
            <p className="lead mb-4" style={{ color: 'var(--color-text-secondary)', fontSize: '1.125rem' }}>
              Experience the future of medical scheduling. Book appointments with top specialists,
              manage your health records, and consult digitally with our secure, AI-powered platform.
            </p>
            ...
            <div className="d-flex flex-wrap gap-3 mb-4">
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <button
                  ...
                  style={{ border: 'none', cursor: 'pointer', padding: '14px 32px', fontSize: '1rem' }}
                >
                  <Calendar size={20} />
                  Book Appointment
